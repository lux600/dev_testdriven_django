...
class NewItemTest(TestCase):
    ...
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.client.post('/lists/%d/add_item' % (correct_list.id), data={'item_text':'기존 목록에 신규 아이템'})
    ...
    def test_redirects_to_list_view(self):
        ...
        response = self.client.post('/lists/%d/add_item' % (correct_list.id), data={'item_text':'기존 목록에 신규 아이템'})
